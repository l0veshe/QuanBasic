...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Strat
            <small>manage Strat</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="/index"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Strat</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover table-bordered" id="strat_table">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>host</th>
...
<script src="/static/dist/js/pages/archive/strat.js"></script>
{% endblock %}
